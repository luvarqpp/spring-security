...
= THIS Fork branch purpose
Purpose of this branch is to show sample for issue created on github project, https://github.com/spring-projects/spring-framework/issues/23647
See subproject samples/boot/oauth2login.
